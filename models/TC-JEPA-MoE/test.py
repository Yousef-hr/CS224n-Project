"""
Test/evaluate JEPA MoE text classifier on Banking77 / CLINC-OOS.
Same as baseline test plus MoE routing and expert similarity metrics when --report_repr_metrics.
"""
...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default="checkpoints/best_jepa_moe.pt")
    ...
    with torch.no_grad():
        for texts, labels in test_loader:
            ...
            pred_emb, gate_probs, expert_outputs = model.forward_with_diagnostics(input_emb)
