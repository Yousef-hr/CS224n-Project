"""Train JEPA + SigReg VQA (frozen CLIP + MLP predictor + BCS regulariser).
...
from .model import VisionQAJEPASigReg
...
def main() -> None:
    ...
    train_spec = TrainSpec(
        ...
        metrics_csv=args.metrics_csv or str(Path(args.save_dir) / "training_metrics_jepa_sigreg.csv"),
    )
