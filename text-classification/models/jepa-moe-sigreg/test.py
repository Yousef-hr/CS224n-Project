"""
Test/evaluate JEPA MoE + SIGReg text classifier.
...
from .train import add_moe_sigreg_args
...
def main() -> None:
    ...
    parser.set_defaults(checkpoint="checkpoints/best_jepa_moe_sigreg.pt")
    ...
    def __model_factory__(labels_list: list[str], embed_dim: int):
        return MoESigRegJEPATextClassifier(
            embed_dim=embed_dim,
